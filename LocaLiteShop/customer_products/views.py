...
# @login_required
def clothes_customer_views(request,seller_id, user_id, username):
    seller = get_object_or_404(ClothesShopSeller, seller_id=seller_id)
...
def fruits_customer_views(request,seller_id, user_id, username):
    seller = get_object_or_404(FruitsShopSeller, seller_id=seller_id)
...
def foods_customer_views(request,seller_id, user_id, username):
    seller = get_object_or_404(FoodsShopSeller,seller_id=seller_id)
...
def grocery_customer_views(request,seller_id, user_id, username):
    seller = get_object_or_404(GroceryShopSeller,seller_id=seller_id)
...
def housecomponent_customer_views(request,seller_id, user_id, username):
    seller = get_object_or_404(HouseComponentShopSeller,seller_id=seller_id)
...
def icecream_customer_views(request,seller_id, user_id, username):
    seller = get_object_or_404(IceCreamShopSeller,seller_id=seller_id)
...
def vegetables_customer_views(request,seller_id, user_id, username):
    seller = get_object_or_404(VegetablesShopSeller,seller_id=seller_id)
...
def electronics_customer_views(request,seller_id, user_id, username):
    seller = get_object_or_404(ElectronicsShopSeller,seller_id=seller_id)
